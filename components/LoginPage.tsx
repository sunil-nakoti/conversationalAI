...
interface LoginPageProps {
    onLogin: (credentials: { email, password }) => Promise<void>;
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-brand-primary p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2">Intelligent Automation Platform</p>
                </div>

                <div className="bg-white dark:bg-brand-secondary rounded-xl shadow-2xl p-8 border border-slate-200 dark:border-slate-700">
                    <h2 className="text-2xl font-bold text-center text-slate-900 dark:text-white mb-6">Sign In</h2>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-3 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md text-slate-900 dark:text-white"
                                required
                            />
                        </div>
                        <div>
                        ...
                        >
                            {isLoading ? <Icon name="spinner" className="h-5 w-5 animate-spin" /> : 'Sign In'}
                        </button>
                    </form>
